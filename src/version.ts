 ...
 * `vite.config.ts` und `vitest.config.ts`).
 *
...
/** Projektseite. Erscheint als dezenter Link in der Kopfzeile. */
export const PROJECT_URL = 'https://github.com/calkoe/meshcore-stats';
